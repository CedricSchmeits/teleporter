...
minetest.register_node("teleporter:teleporter_pad", {
    ...
    after_place_node = function(pos, placer)
        ...
        local itext = "Position where to teleport to"

        meta:set_string("formspec",
            "formspec_version[4]" ..
            "size[10.0,3.5]" ..
            "label[1,0.5;Teleport to " .. teleporter.default_coordinates.desc .. "]" ..
            "field[0.5,1.0;1.1,0.5;x;X;" .. meta:get_float("x") .. "]" ..
            "field[1.7,1.0;1.1,0.5;y;Y;" .. meta:get_float("y") .. "]" ..
            "field[2.9,1.0;1.1,0.5;z;Z;" .. meta:get_float("z") .. "]" ..
            "field[5.0,1.0;3.5,0.5;desc;Description;" .. meta:get_string("desc") .. "]" ..
            "button[1.5,2.3;3,0.8;save;Save]")
    ...
    on_receive_fields = function(pos, formname, fields, sender)
        minetest.debug("on_receive_fields -> formname(" .. formname .. "); sender(" .. sender:  get_player_name() .. ")")
        if fields.save then
